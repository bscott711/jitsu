...
@pytest.mark.asyncio
@patch("jitsu.providers.file.Path.cwd")
async def test_file_provider_success(mock_cwd: MagicMock, tmp_path: Path) -> None:
...
@pytest.mark.asyncio
@patch("jitsu.providers.file.Path.cwd")
async def test_file_provider_not_exist(mock_cwd: MagicMock, tmp_path: Path) -> None:
...
@pytest.mark.asyncio
@patch("jitsu.providers.file.Path.cwd")
async def test_file_provider_is_dir(mock_cwd: MagicMock, tmp_path: Path) -> None:
...
@pytest.mark.asyncio
@patch("jitsu.providers.file.Path.cwd")
async def test_file_provider_read_error(mock_cwd: MagicMock, tmp_path: Path) -> None:
