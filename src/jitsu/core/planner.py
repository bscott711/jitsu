...
class JitsuPlanner:
    ...
    async def generate_plan(
        ...
        blueprint = await client.chat.completions.create(
            model=_model,
        ...
        # Pass 2: Micro - Elaborate each phase (sequential - Instructor is sync)
        self.directives = []
        for i, phase in enumerate(blueprint.phases):
            ...
            directive = await client.chat.completions.create(
                model=_model,
