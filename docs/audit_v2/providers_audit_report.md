...
src/jitsu/providers/git.py:43: unused method 'resolve' (60% confidence)
...
providers/ast.py
    ...
    ASTProvider::_format_function_def 3 
PASSED
    ASTProvider::_format_class_def 4 
PASSED
...
providers/markdown.py
    ...
    MarkdownASTProvider::_is_structural 5
PASSED
...
providers/tree.py
    DirectoryTreeProvider::_get_sorted_it
ems 0 PASSED
    DirectoryTreeProvider::name 0 PASSED
    DirectoryTreeProvider::resolve 6 
PASSED
    DirectoryTreeProvider::_generate_tree
_lines 14 PASSED
